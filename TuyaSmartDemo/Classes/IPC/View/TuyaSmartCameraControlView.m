...
@implementation TuyaSmartCameraControlView
...
- (void)enableControl:(NSString *)identifier {
    [self.subviews enumerateObjectsUsingBlock:^(TuyaSmartCameraControlButton *obj, NSUInteger idx, BOOL *stop) {
...
- (void)controlAction:(UITapGestureRecognizer *)recognizer {
    TuyaSmartCameraControlButton *controlButton = (TuyaSmartCameraControlButton *)recognizer.view;
