...
@interface TYCameraCalendarView() <UICollectionViewDataSource, UICollectionViewDelegate>
...
//IB_DESIGNABLE
@implementation TYCameraCalendarView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:[UIScreen mainScreen].bounds]) {
        self.hidden = YES;
        [self.collectionView registerClass:[TYCameraCalendarCollectionViewCell class] forCellWithReuseIdentifier:CellIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TYCameraCalendarCollectionViewCell *cell = (TYCameraCalendarCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
...
- (NSArray<UILabel *> *)weekdayLabels {
    if (!_weekdayLabels) {
        ...
        NSArray *titles = @[
                           NSLocalizedString(@"pps_day_sun", @""),
                           NSLocalizedString(@"pps_day_mon", @""),
                           NSLocalizedString(@"pps_day_tue", @""),
                           NSLocalizedString(@"pps_day_wed", @""),
                           NSLocalizedString(@"pps_day_thu", @""),
                           NSLocalizedString(@"pps_day_fri", @""),
                           NSLocalizedString(@"pps_day_sat", @""),
                           ];
