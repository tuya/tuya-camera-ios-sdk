...
- (void)cameraSnapshootDidSaved:(TuyaSmartCameraDefault *)camera;

- (void)camera:(TuyaSmartCameraDefault *)camera didReceiveFirstFrame:(UIImage *)image;
...
@interface TuyaSmartCameraDefault : NSObject <TuyaSmartCameraDelegate>
